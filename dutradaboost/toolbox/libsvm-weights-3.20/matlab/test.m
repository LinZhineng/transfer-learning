...
[model,beta] = TrAdaBoostTrain(source.trn.features,source.trn.labels,target.trn.features([1:3,31:33],:),target.trn.labels([1:3,31:33],:));
label = TrPredict(target.test.features, model, beta);
rightcount0 = 0;
rightcount1 = 0;
total0 = 0;
total1 = 0;
